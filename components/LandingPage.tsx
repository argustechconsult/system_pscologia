...
const LandingPage: React.FC<LandingPageProps> = ({
  ...
  const handleBookingSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log(
        `[Notification System] Sending to ${clientInfo.email}: ${message}`,
      );
      console.log(
        `[Notification System] Sending WhatsApp to ${clientInfo.phone}: ${message}`,
      );
    ...
    <div className="min-h-screen scroll-smooth overflow-x-hidden font-sans">
      ...
      <nav className="fixed top-0 w-full bg-white/90 backdrop-blur-md z-50 border-b border-slate-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          >
            <span className="text-xl font-bold text-teal-900 leading-tight group-hover:text-teal-600 transition-colors">
              Soraia
            </span>
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a
              ...
              className="text-slate-600 hover:text-teal-600 font-semibold transition-colors"
            >
              Início
            </a>
            <a
            ...
            <button
              ...
              className="btn-attention bg-teal-600 text-white px-6 py-2.5 rounded-xl font-bold hover:bg-teal-700 transition-all shadow-lg"
            >
              Agendar Consulta
            </button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-b border-slate-100 p-6 space-y-4 animate-fade-in shadow-xl">
            ...
            <Link
              href="/login"
              className="block py-2 text-teal-700 font-bold border-t border-slate-50 pt-4"
            >
              Acesso Profissional
            </Link>
            <button
      ...
      <section
        id="inicio"
        className="pt-32 pb-20 bg-gradient-to-br from-teal-50 via-white to-blue-50 scroll-mt-20"
      >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in text-center md:text-left">
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-slate-900 leading-[1.1] tracking-tight">
                Cuidado humano pautado na{' '}
                <span className="text-teal-600 italic">Ciência</span>.
              </h1>
              <p className="text-xl text-slate-600 leading-relaxed max-w-lg mx-auto md:mx-0">
                Soraia é Psicóloga Clínica e Neuropsicóloga dedicada a auxiliar
                pessoas em seu processo de autoconhecimento, saúde mental e
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="order-2 md:order-1">
              <h2 className="text-4xl font-bold text-slate-900 mb-8 leading-tight">
                Trajetória e{' '}
                <span className="text-teal-600">Formação Profissional</span>
              </h2>
              <div className="space-y-6 text-slate-600 text-lg leading-relaxed">
                <p>
                  Graduada pela{' '}
                  <span className="font-bold text-slate-800 underline decoration-teal-300 decoration-4 underline-offset-4">
                    PUC Rio
                  </span>
                  , com especialização em Neuropsicologia, Soraia combina a
                  escuta empática da psicologia clínica com a precisão dos
                  testes neuropsicológicos.
                </p>
                <p>
                  Seu trabalho é fundamentado na{' '}
                  <span className="italic">
                    Terapia Cognitivo-Comportamental (TCC)
                  </span>
                  , oferecendo ferramentas práticas para que seus pacientes
                  lidem com os desafios do dia a dia.
                </p>
                <div className="grid grid-cols-2 gap-4 pt-4">
                  <div className="p-6 bg-teal-50 rounded-2xl border border-teal-100 text-center">
                    ...
                    <p className="text-[10px] uppercase font-bold text-teal-600/60 tracking-widest mt-1">
                      Registro
                    </p>
                  </div>
                  <div className="p-6 bg-blue-50 rounded-2xl border border-blue-100 text-center">
                    <p className="text-blue-700 font-bold text-3xl">PUC Rio</p>
                    <p className="text-[10px] uppercase font-bold text-blue-600/60 tracking-widest mt-1">
                      Bacharelado
                    </p>
                  </div>
                </div>
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">
                      Respeito total à individualidade e privacidade.
                    </p>
                  </div>
                </li>
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">
                      Protocolos validados para avaliação e tratamento clínico.
                    </p>
                  </div>
                </li>
              </ul>
      ...
      <section
        id="especialidades"
        className="py-24 bg-slate-50 text-center scroll-mt-20"
      >
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-8 px-4">
          <div className="p-10 bg-white rounded-[2.5rem] border border-slate-100 hover:shadow-2xl transition-all group">
            ...
            <p className="text-slate-600 mb-6">
              Atendimento humanizado focado em adolescentes e adultos,
          ...
          <div className="p-10 bg-white rounded-[2.5rem] border border-slate-100 hover:shadow-2xl transition-all group">
            ...
            <p className="text-slate-600 mb-6">
              Avaliação técnica detalhada de funções cognitivas como memória e
              atenção, com emissão de laudos.
            </p>
            <ul className="space-y-2 text-slate-500 font-semibold text-sm">
      ...
      <footer className="bg-slate-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 text-center space-y-4">
          <div className="flex flex-col">
            ...
            <span className="text-xs text-teal-600 uppercase tracking-widest">
              Psicóloga CRP 05/64585
            </span>
          </div>
          <p className="text-slate-400 text-sm">
            © 2024 Soraia - Psicologia & Neuropsicologia. Rio de Janeiro,
            Brasil.
          </p>
        </div>
      </footer>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-md">
          <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-lg overflow-hidden relative animate-scale-up">
            <button
              ...
              className="absolute top-6 right-6 text-slate-400 hover:text-slate-900 z-10 transition-colors p-2 hover:bg-slate-50 rounded-full"
            >
              ✕
            </button>
                ...
                <div className="py-20 flex flex-col items-center justify-center space-y-6 animate-pulse">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-slate-500 text-sm mt-2">
                      Gerando sala virtual e enviando notificações.
                    </p>
                  </div>
                </div>
              ) : (
                    ...
                    <form onSubmit={handleBookingSubmit} className="space-y-6">
                      ...
                      <div className="space-y-4">
                        <input
                          type="text"
                          required
                          className="w-full bg-slate-50 border border-slate-200 rounded-2xl py-4 px-5 font-semibold focus:ring-2 focus:ring-teal-500 outline-none"
                      ...
                      <div className="flex gap-4">
                        <button
                          ...
                          className="flex-1 bg-slate-100 text-slate-600 py-5 rounded-2xl font-bold hover:bg-slate-200"
                        >
                          Voltar
                        </button>
                        <button
                          type="submit"
                          className="flex-[2] bg-teal-600 text-white py-5 rounded-2xl font-bold text-lg flex items-center justify-center gap-3 hover:bg-teal-700"
                        >
                    ...
                    <div className="text-center space-y-8 animate-fade-in py-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-500 font-medium mt-2">
                          O link da sala foi enviado para o seu WhatsApp e
                          E-mail.
                        </p>
                      </div>
                      <div className="bg-slate-900 rounded-[2rem] p-8 text-left text-white relative overflow-hidden">
                        <div className="flex items-center gap-4 border-b border-white/10 pb-5 mb-5">
                          ...
                          <div>
                            <p className="text-[10px] font-bold text-teal-400 uppercase tracking-widest">
                              Sua Sala no Google Meet
                            </p>
                            <a
                              href={finalAppointment.meetLink}
                              target="_blank"
                              rel="noreferrer"
                              className="font-bold text-lg break-all hover:text-teal-300"
                            >
                              Acessar Consulta
                            </a>
                          </div>
                        ...
                        <p className="text-xs text-slate-400">
                          Guarde este link. Ele será o portal para nossa sessão
                          online no dia agendado.
                        </p>
                      </div>
                      <button
                        onClick={closeBooking}
